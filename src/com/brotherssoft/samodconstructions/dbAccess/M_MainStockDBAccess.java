...
public class M_MainStockDBAccess {
    ...
    public boolean updateMainStockQuantity(String itemId, double quantity) throws Exception {
        String sql = "Update m_mstock set MSTOCK_QUANTITY=? where MSTOCK_EQUIPMENTID=?";
        Connection conn = DBConnection.getDBConnection().getConnection();
        PreparedStatement stm = conn.prepareStatement(sql);
